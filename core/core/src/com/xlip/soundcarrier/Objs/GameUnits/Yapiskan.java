 ...
 */
public class Yapiskan extends Box {
    World world;

    public Yapiskan(World world,Vector2 pos){
        super(BodyDef.BodyType.StaticBody,new Vector2(0.7f,0.7f), pos,world.world2d );
        this.world=world;
        set_fixture(1,1,0).set_body_data(new BodyData("yapiskan",1)).set_anim(Asset.yapiskan);
